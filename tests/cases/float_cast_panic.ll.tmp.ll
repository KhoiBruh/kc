...
define i8 @checked(double %arg.value) {
entry:
  
  %local.15 = alloca double
  store double %arg.value, ptr %local.15
  %0 = load double, ptr %local.15
  %1 = fcmp ogt double %0, -1.0
  %2 = fcmp olt double %0, 256.0
  %3 = and i1 %1, %2
  br i1 %3, label %b0, label %b1
b1:
  %4 = getelementptr inbounds [24 x i8], ptr @.kpanic_float, i64 0, i64 0
  call void @k_boot_panic(ptr %4, i64 23)
  unreachable
b0:
  %5 = fptoui double %0 to i8
  ret i8 %5
...
entry:
  ...
  %0 = call i8 @checked(double 300.0)
  %1 = zext i8 %0 to i32
  ret i32 %1
